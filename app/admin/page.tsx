...
import {
  ...
  LayoutDashboard, ClipboardList, Settings, ChevronLeft, Plus, ArrowUpRight, Loader2
} from "lucide-react";
      ...
      <div className="flex-1 overflow-auto relative">
        ...
        <div className="bg-[#0a0a0a] border-b border-[#1a1a1a] px-8 py-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-[#555] text-xs uppercase tracking-widest mt-1">Welcome back, Owner 👋</p>
          </div>
        ...
        <div className="p-8 space-y-10">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    {data.recentOrders.length === 0 && !loading && (
                      <tr><td colSpan={5} className="p-8 text-center text-[#555] text-xs">No Recent Orders</td></tr>
                    )}
            ...
            <div className="bg-[#0a0a0a] border border-[#1a1a1a] flex flex-col">
              <div className="flex items-center justify-between px-6 py-4 border-b border-[#1a1a1a]">
                <h2 className="font-serif font-bold tracking-widest text-sm uppercase">Recent Products</h2>
              ...
              <div className="divide-y divide-[#0f0f0f] flex-1">
                {data.recentProducts.length === 0 && !loading && (
                    <div className="p-8 text-center text-[#555] text-xs">No Products</div>
                )}
